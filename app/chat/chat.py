...
from app.chat.vector_stores import retriever_map # declared in __init__.py file
...
def build_chat(chat_args: ChatArgs):
    ...
    print(f"running chain with memory: {memory_name}, retriever: {retriever_name}, memory: {memory_name}")
